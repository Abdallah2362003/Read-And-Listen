...
const FloatingEmoji = ({ emoji }) => {
  ...
  return (
    <motion.div
      initial={{ x: randomX, y: randomY, opacity: 0, scale: randomScale }}
      animate={{
        x: [randomX, randomX + 100, randomX - 50, randomX],
        y: [randomY, randomY + 50, randomY - 30, randomY],
        opacity: [0, 0.3, 0.3, 0],
        scale: [randomScale, randomScale + 0.2, randomScale, randomScale],
      }}
      transition={{
